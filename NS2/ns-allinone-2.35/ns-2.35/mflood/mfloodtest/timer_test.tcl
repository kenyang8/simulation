...
set opt(cp)            "/home/relax/Ken/shell/cbr_test.tcl"
set opt(sc)             "/home/relax/Ken/simulation/VanetMobism/samples/mobility/DRIVE50/DRIVE_n400_s3.tcl" ; #DRIVE_test.tcl

set opt(ifqlen)         64           ;# max packet in ifq
set opt(nn)           402   ;# how many nodes are simulated
set opt(seed)           2.0
set opt(stop)	   80;
set opt(rp)   		MFlood       ;
...
Phy/WirelessPhy set RXThresh_ 8.91754e-10 ;  #250 //3.65262e-10    # 200// 8.91754e-10
...
$ns_ at $opt(stop).00000000000001 "puts \"NS EXITING...\" ; $ns_ halt"
