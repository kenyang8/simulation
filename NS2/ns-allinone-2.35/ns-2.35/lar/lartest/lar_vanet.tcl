...
#set val(rp)         DSDV
set val(nn)         50
set val(txPower)    0.2818 ; #100 meters   # 傳送消耗的電力 0.0075
set val(rxPower)    1          ; # 接收消耗的電力
set val(sc)          "/home/relax/Ken/simulation/VanetMobism/samples/mobility/n30s1.tcl"
#/home/relax/Ken/simulation/VanetMobism/samples/mobility/n30s1
#"/home/relax/Ken/simulation/lar_mobility/n50sp0s10"
set val(dataStart)  31.0
set val(dataStop)   231.0
set val(signalStop) 299.0
set val(finish)     300.0
...
for {set k $val(dataStart)} {$k < $val(dataStop)} {set k [expr $k + 0.5] } \
{
  $ns_ at $k "$g(0) sendData 10 512 B"
  $ns_ at [expr $k + .546464544] "$g(1) sendData 11 512 B"
  $ns_ at [expr $k + .656464555] "$g(2) sendData 12 512 B"
