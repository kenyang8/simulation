...
set val(dataStop)   180.0
set val(signalStop) 199 
#1990.0
set val(finish)     230
#2000.0
...
{
  $ns_ at $k "$g(0) sendData 49 512 B"
  $ns_ at [expr $k + .0001] "$g(1) sendData 48 512 B"
  $ns_ at [expr $k + .0002] "$g(2) sendData 47 512 B"
  $ns_ at [expr $k + .0003] "$g(3) sendData 46 512 B"
  $ns_ at [expr $k + .0004] "$g(4) sendData 45 512 B"
  $ns_ at [expr $k + .0005] "$g(5) sendData 44 512 B"
  $ns_ at [expr $k + .0006] "$g(6) sendData 43 512 B"
  $ns_ at [expr $k + .0007] "$g(7) sendData 42 512 B"
  $ns_ at [expr $k + .0008] "$g(8) sendData 41 512 B"
  $ns_ at [expr $k + .0009] "$g(9) sendData 40 512 B"
  $ns_ at [expr $k + .0010] "$g(10) sendData 39 512 B"
  $ns_ at [expr $k + .0011] "$g(11) sendData 38 512 B"
  $ns_ at [expr $k + .0012] "$g(12) sendData 37 512 B"
  $ns_ at [expr $k + .0013] "$g(13) sendData 36 512 B"
  $ns_ at [expr $k + .0014] "$g(14) sendData 35 512 B"
  $ns_ at [expr $k + .0015] "$g(15) sendData 34 512 B"
  $ns_ at [expr $k + .0016] "$g(16) sendData 33 512 B"
  $ns_ at [expr $k + .0017] "$g(17) sendData 32 512 B"
  $ns_ at [expr $k + .0018] "$g(18) sendData 31 512 B"
  $ns_ at [expr $k + .0019] "$g(19) sendData 30 512 B"
}
