...
for {set k $val(dataStart)} {$k < $val(dataStop)} {set k [expr $k + 0.25] } \
{
     ...
     $ns_ at $k "$g(0) sendData 25 512 B"
  $ns_ at [expr $k + .0001] "$g(1) sendData 25 512 B"
  $ns_ at [expr $k + .0002] "$g(2) sendData 25 512 B"

  $ns_ at [expr $k + .0003] "$g(3) sendData 25 512 B"
  $ns_ at [expr $k + .0004] "$g(4) sendData 25 512 B"
  $ns_ at [expr $k + .0005] "$g(5) sendData 25 512 B"
  $ns_ at [expr $k + .0006] "$g(6) sendData 25 512 B"
  $ns_ at [expr $k + .0007] "$g(7) sendData 25 512 B"
  $ns_ at [expr $k + .0008] "$g(8) sendData 25 512 B"
  $ns_ at [expr $k + .0009] "$g(9) sendData 25 512 B"
  $ns_ at [expr $k + .0010] "$g(10) sendData 25 512 B"
  $ns_ at [expr $k + .0011] "$g(11) sendData 25 512 B"  
  $ns_ at [expr $k + .0011] "$g(12) sendData 25 512 B"
